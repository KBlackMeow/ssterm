...
class _TerminalPage extends StatelessWidget {
  ...
  static Future<void> _showCommandsSheet(
    ...
    final popupColor =
        AppColors.maybeOf(context)?.popup ?? FrostedGlassStyle.menuFillSolid;
...
class _SessionTabStrip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final border = (AppColors.maybeOf(context)?.foreground ?? Colors.white)
...
class _CommandsSheetState extends State<_CommandsSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_loading) {
      ...
      final fg = colors?.foreground ?? _kFgActive;
      final fgDim = colors?.foregroundDim ?? _kFgInactive;
      final divColor = (colors?.foregroundDim ?? _kFgInactive).withValues(
        alpha: 0.18,
      );
      final rows = <Widget>[
...
class _MobileSettingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _GlassNavBar(title: 'Settings', chromeBackground: chromeBackground),
        Expanded(
          child: SettingsPage(
            settings: settings,
            onChanged: onChanged,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'No active sessions',
                style: TextStyle(
                  color: fgDim.withValues(alpha: 0.6),
                  fontSize: 15,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: fgDim.withValues(alpha: 0.45),
                      fontSize: 13,
                      height: 1.55,
                    ),
                  ),
